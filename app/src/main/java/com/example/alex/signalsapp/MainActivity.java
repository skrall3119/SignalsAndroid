...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(this, R.array.modes, android.R.layout.simple_spinner_item);

        adapter1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        Spinner modeSpinner = findViewById(R.id.modes);
        Spinner spinner = findViewById(R.id.keys);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
        ...
        Spinner spinner = findViewById(R.id.keys);
        final Spinner modeSpinner = findViewById(R.id.modes);
        ...
        TextView chordi = findViewById(R.id.chordi);
        TextView chordii = findViewById(R.id.chordii);
        TextView chordiii = findViewById(R.id.chordiii);
        TextView chordiv = findViewById(R.id.chordiv);
        TextView chordv = findViewById(R.id.chordv);
        TextView chordvi = findViewById(R.id.chordvi);
        TextView chordvii = findViewById(R.id.chordvii);
        ...
        generator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextView firstChord = findViewById(R.id.firstChordText);
                TextView secondChord = findViewById(R.id.secondChordText);
                TextView thirdChord = findViewById(R.id.thirdChordText);
                TextView fourthChord = findViewById(R.id.fourthChordText);
